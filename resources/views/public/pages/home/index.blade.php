            ...
            <div class="row g-4">
                <div class="col-lg-3 col-sm-6 wow fadeInUp" data-wow-delay="0.1s">
                    <a class="cat-item d-block bg-light text-center rounded p-3" href="">
                        <div class="rounded p-4">
                            <div class="icon mb-3">
                                <img class="img-fluid" src="{{ Vite::asset('resources/images/icon-apartment.png') }}"
                                    alt="Icon">
                            </div>
                            <h6>Chung cư</h6>
                ...
                <div class="col-lg-3 col-sm-6 wow fadeInUp" data-wow-delay="0.3s">
                    <a class="cat-item d-block bg-light text-center rounded p-3" href="">
                        <div class="rounded p-4">
                            <div class="icon mb-3">
                                <img class="img-fluid" src="{{ Vite::asset('resources/images/icon-villa.png') }}"
                                    alt="Icon">
                            </div>
                            <h6>Nhà trọ</h6>
                            <span>123 Properties</span>
                ...
                <div class="col-lg-3 col-sm-6 wow fadeInUp" data-wow-delay="0.5s">
                    <a class="cat-item d-block bg-light text-center rounded p-3" href="">
                        <div class="rounded p-4">
                            <div class="icon mb-3">
                                <img class="img-fluid" src="{{ Vite::asset('resources/images/icon-house.png') }}"
                                    alt="Icon">
                            </div>
                            <h6>Nhà đất</h6>
                            <span>123 Properties</span>
                ...
                <div class="col-lg-3 col-sm-6 wow fadeInUp" data-wow-delay="0.7s">
                    <a class="cat-item d-block bg-light text-center rounded p-3" href="">
                        <div class="rounded p-4">
                            <div class="icon mb-3">
                                <img class="img-fluid" src="{{ Vite::asset('resources/images/icon-housing.png') }}"
                                    alt="Icon">
                            </div>
                            <h6>Văn phòng</h6>
                            <span>123 Properties</span>
