                                                            ...
                                                            <td class="pad">
                                                                <div
                                                                    ...
                                                                    <p style="margin: 0; word-break: break-word;">
                                                                        <strong><span>Quên mật khẩu?</span></strong>
                                                                    </p>
                                                                </div>
                                                            </td>
                                                        </tr>
                                                        ...
                                                        <tr>
                                                            <td class="pad">
                                                                <div
                                                                    ...
                                                                    <p style="margin: 0; word-break: break-word;">
                                                                        <span>Xin chào, chúng tôi đã nhận được yêu cầu
                                                                            đặt lại mật khẩu của bạn.</span>
                                                                    </p>
                                                                </div>
                                                            </td>
                                                        </tr>
                                                        ...
                                                        <tr>
                                                            <td class="pad">
                                                                <div
                                                                    style="color:#40507a;font-family:Helvetica Neue, Helvetica, Arial, sans-serif;font-size:16px;line-height:120%;text-align:left;mso-line-height-alt:19.2px;">
                                                                    <p style="margin: 0; word-break: break-word;">
                                                                        <span>Hãy đặt một mật khẩu mới!</span>
                                                                    </p>
                                                                </div>
                                                            </td>
                                                        </tr>
...
<![endif]--><a href="{{}}" target="_blank" style="text-decoration:none;display:inline-block;color:#ffffff;background-color:#506bec;border-radius:16px;width:auto;border-top:0px solid TRANSPARENT;font-weight:undefined;border-right:0px solid TRANSPARENT;border-bottom:0px solid TRANSPARENT;border-left:0px solid TRANSPARENT;padding-top:8px;padding-bottom:8px;font-family:Helvetica Neue, Helvetica, Arial, sans-serif;font-size:15px;text-align:center;mso-border-alt:none;word-break:keep-all;"><span
                                                                            style="padding-left:25px;padding-right:20px;font-size:15px;display:inline-block;letter-spacing:normal;"><span
                                                                                style="word-break:break-word;"><span
                                                                                    ...
                                                                                    data-mce-style><strong>Đặt lại mật
                                                                                        khẩu của
                                                                                        bạn</strong></span></span></span></a>
                                                        ...
                                                        <tr>
                                                            <td class="pad">
                                                                <div
                                                                    ...
                                                                    <p style="margin: 0; word-break: break-word;">
                                                                        <span>Nếu bạn gặp rắc rối ?<a
                                                                                href="http://www.rental.com/"
                                                                                target="_blank" title="@rental"
                                                        ...
                                                        <tr>
                                                            <td class="pad">
                                                                <div
                                                                    style="color:#40507a;font-family:Helvetica Neue, Helvetica, Arial, sans-serif;font-size:14px;line-height:120%;text-align:left;mso-line-height-alt:16.8px;">
                                                                    <p style="margin: 0; word-break: break-word;">
                                                                        Không yêu cầu đặt lại mật khẩu? Bạn có thể bỏ
                                                                        qua thông báo này.</p>
                                                                </div>
                                                            </td>
                                                        </tr>
                                                    ...
                                                    <table class="paragraph_block block-4" width="100%"
                                                        ...
                                                        <tr>
                                                            <td class="pad">
                                                                <div
                                                                    style="color:#97a2da;font-family:Helvetica Neue, Helvetica, Arial, sans-serif;font-size:14px;line-height:120%;text-align:center;mso-line-height-alt:16.8px;">
                                                                    <p style="margin: 0; word-break: break-word;">Liên
                                                                        kết này sẽ hết hạn trong 24 giờ tới.<br>Vui lòng
                                                                        liên hệ với chúng tôi theo địa chỉ
                                                                        support@rental.com</p>
                                                                </div>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                        ...
                                                        <tr>
                                                            <td class="pad">
                                                                <div
                                                                    ...
                                                                    <p style="margin: 0; word-break: break-word;">
                                                                        <span>Copyright© 2021 Your Brand.</span>
                                                                    </p>
                                                                    <p style="margin: 0; word-break: break-word;">
                        ...
                        <tbody>
                            <tr>
                                <td>
                                    <table class="row-content stack" align="center" border="0" cellpadding="0"
                                        cellspacing="0" role="presentation"
                                        style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; color: #000000; background-color: #ffffff; width: 600px; margin: 0 auto;"
                                        width="600">
                                        <tbody>
                                            <tr>
                                                <td class="column column-1" width="100%"
