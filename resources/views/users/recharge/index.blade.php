...
@section('content')
    ...
    <div class="row">
        <div class="col-md-8">
            ...
            <div class="method-container">
                @foreach ($method as $item)
                    <div class="method-card">
                        <a
                            href="{{ route('recharge.redirect-transfer', ['slug' => Illuminate\Support\Str::slug($item['name']), 'id' => $item['id']]) }}">
            ...
            <a href="{{ route('recharge.history') }}" class="btn btn-info">Lịch sử nạp tiền</a>
        </div>
    </div>
@endsection
