...
class RoomDataTable extends DataTable
{
    ...
    public function getColumns(): array
    {
        return [
            ...
            // Column::make('avatar'),
            Column::make('title')->title('Tiêu đề')->width(350),
            Column::make('price')->title('Giá'),
            Column::make('hot_service')->title('Loại dịch vụ'),
            Column::make('starting_date')->title('Ngày bắt đầu'),
            Column::make('expiration_date')->title('Ngày kết thúc'),
